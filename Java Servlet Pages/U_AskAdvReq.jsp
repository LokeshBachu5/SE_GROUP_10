...
<head>
<title>User Ask Advertisement Adding Request</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2><span class="style3">Ask Permission To Upload Advertisement Details</span></h2>
          <form name="s" method="post" action="U_AskAdvReq0.jsp" onSubmit="return valid()"  ons>
	...
	<td>
	  <input type="text" id="d1" name="d1" style="width:100%" placeholder="DD/MM/YYYY" required />	 </td>
	</tr> 
  <tr>
	<td>
	  <div align="right" class="style4 style3"><span class="style13"><font size="+1"> To Date :</font></span></div></td> 
	 <td> <input type="text" id="d2" name="d2" style="width:100%" placeholder="DD/MM/YYYY" required />	</td>
	</tr>
	
	<tr>
	<td><span class="style3"></span></td>
	<td><input type="submit" value="Request" id="button1"><input type="reset" value="clear"></td>
		  </tr>
	</table>	</td>
	</tr>
	</table>
