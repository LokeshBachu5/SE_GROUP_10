...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2 align="center"><span class="style3">All Blocked Users with IP Address</span></h2>
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<%
						...
						try 
						{
							String sql="select uname,ip,blockdate from evidence where status='block' group by uname ";
		...
		<tr>
			  ...
			  <div align="left" class="style6 style10" style="margin-left:20px;"><a href="A_UserProfile.jsp?type1=<%=s1%>&type=<%="user7"%>"><%=s1%></a></div></td>
			    <td  width="182" valign="middle" height="44" style="color:#000000;">
...
<%					
						...
						if(count==0){
										out.print("There is No Blocked Users Found");
								}
