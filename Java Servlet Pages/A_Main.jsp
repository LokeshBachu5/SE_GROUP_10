      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style2">
			...
			<li><a href="A_MalaciousFileUser.jsp">View All Malacious Users Details With IP Address</a></li>
			<li><a href="A_AllUserRecomend.jsp">View All Advertisement Recommended Users Details</a></li>
			<li><a href="A_UserAdvReq.jsp">View Advertisement Request Users And Calculate Number Of Months That You Want To Advetise</a></li>
			...
			<li><a href="A_BlockedUsers.jsp">View All Blocked Users With IP address</a></li>
			<li><a href="A_BlockEvidense.jsp">View All Blocked Users Evidence With IP address</a></li>
			<li><a href="A_MalacNormUseChart.jsp">View Number Of Malacious And Number Of Normal Users In Chart</a></li>
