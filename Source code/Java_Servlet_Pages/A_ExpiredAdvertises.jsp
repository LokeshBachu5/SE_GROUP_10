...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2><span class="style3">View All Users Expired Advertisement Details...</span></h2>
        ...
        <tr bgcolor="#99CCCC">
          ...
          <td  width="146" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style22 style7 style8 style6 style15 style3"><strong>Company Name </strong></div></td>
		   <td  width="145" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style22 style7 style8 style6 style15 style3"><strong>Advertisement Image</strong></div></td>
			<td  width="145" height="34" valign="baseline" style="color: #2c83b0;"><div align="center" class="style22 style7 style8 style6 style15 style3"><strong> Expired Date </strong></div></td>
            ...
            <tr>
              <td  valign="middle" height="0">
			   ...
			   <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
             	<a href="A_UserProfile.jsp?type1=<%=s4%>&type=<%="f"%>"> <%=s4%> </a>
                </div></td>
			  <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
              				<%=s1%>
              ...
              <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
                    <a href="A_AdvertisementDetail.jsp?aname=<%=s2%>&id=<%=j%>&type=<%="expire"%>"><%=s2%></a>
              </div></td>
              <td  valign="middle" height="0">
                  <div align="center" class="style23 style2">
             			  <%=s3%>
			  ...
			  <%
				...
				%></table>
          <%	
					if(count==0){out.print("No one Expired Advertisements");}%>
