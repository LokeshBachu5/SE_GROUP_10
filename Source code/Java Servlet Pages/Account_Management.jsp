...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <h2><span class="style3">WELCOME TO ACCOUNT MANAGMENT USER <%=(String)application.getAttribute("uname")%></span></h2>
        </div>
        <div class="article">
				<li><a href="User_Acc_Reg.jsp">Create Account</a> </li>
				<li><a href="Add_Money.jsp">Add Money</a> </li>
				<li><a href="View_User_Acc_Detail.jsp">View Account</a> </li>
				<li><a href="U_MiniStatement.jsp">Ministatement</a> </li>
          <p>&nbsp;</p>
