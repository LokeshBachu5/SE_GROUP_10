...
<head>
<title>Admin View Malacious Users Those Advertises Without Balance</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
       <h2><span class="style3">All Malacious User Those Who Try To Advertise withount Balance</span></h2>
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<%
						...
						try 
						{
							String sql="select * from evidence where type='amount' ";
		...
		<tr>
			  ...
			  <div align="left" class="style6 style10" style="margin-left:20px;"><a href="A_UserProfile.jsp?type1=<%=s1%>&type=<%="user6"%>"><%=s1%></a></div></td>
			    <td  width="182" valign="middle" height="44" style="color:#000000;">
			...
			<% if(s3.equalsIgnoreCase("unblock")){%>
			 <td  width="182" valign="middle" height="44" style="color:#000000;">
			<div align="left" class="style6 style10" style="margin-left:20px;"><a href="A_BlockUser.jsp?user=<%=s1%>&type=<%="amount"%>">Block</a></div></td>
			<%}else{%>
			<td  width="182" valign="middle" height="44" style="color:#000000;">
