...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <h2><span class="style3">Search Friends...</span></h2>
            
           <form name="s" action="U_SearchFriend.jsp" method="post"  onSubmit="return valid()"  ons target="_top"> 
            <table width="500">
              <tr>
                <td width="150" height="50" bgcolor="#00FFFF"><span class="style6 style3"><em><strong>Enter  Friend Name </strong></em></span></td>
                <td width="140" bgcolor="#00FFFF"><input type="text" name="keyword" required /></td>
                <td width="95"><label>
