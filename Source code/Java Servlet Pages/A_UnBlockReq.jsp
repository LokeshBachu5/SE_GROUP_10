...
<head>
<title>Admin All Users UnBlock Request</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2><span class="style3">All Users Request For Unblock Account</span></h2>
		<p><table width="300" border="1" align="center"  cellpadding="0" cellspacing="0" >
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
		...
		<tr>
			  ...
			  <div align="left" class="style6 style10" style="margin-left:20px;"><a href="A_UserProfile.jsp?type1=<%=s1%>&type=<%="user1"%>"><%=s1%></a></div></td>
			 
			<% if(s2.equalsIgnoreCase("requested")){%>
			 <td  width="182" valign="middle" height="44" style="color:#000000;">
			<div align="left" class="style6 style10" style="margin-left:20px;"><a href="A_UnBlockUser.jsp?user=<%=s1%>">UnBlock</a></div></td>
			<%}else{%>
			<td  width="182" valign="middle" height="44" style="color:#000000;">
...
<%					
						...
						if(count==0){
										out.print("There Is No UnBlock Request Found From Users");
								}
