...
<head>
<title>User Search Friends and View Friend Requests</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
           <h2><span class="style3">Search Friends And See Friend Requests</span></h2>
					<p>&nbsp;</p>
              <table width="551" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                     <td><a href="U_SearchFrd.jsp" >1. Search Friends </a></td>
                     <td><a href="U_FriendReq.jsp" >2. Friend Requests </a></td>
                    </tr>
              </table>
