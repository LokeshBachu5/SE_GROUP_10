...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
      <h2 align="center"> <span class="style3">ADD MONEY...</span></h2>
	  <p>&nbsp;</p>
	  <%
		  String uname=(String)application.getAttribute("uname");
		
		   String query8="select acc_no from account where user='"+uname+"' "; 
			Statement st8=connection.createStatement();
		 	ResultSet rs8=st8.executeQuery(query8);
			if ( rs8.next() )
			{	
				String accno=rs8.getString(1);
	  %>
          ...
          <p align="center">
            <label for="name"><span class="style3">Account Number(required)</span></label>
                        ...
                        <p align="center" class="style3">
                          <input type="text"  name="accno" class="text" value="<%=accno%>" />
                        </p>
                       <P align="center"> <span class="style3">
                        ...
                        <p align="center" ><br />
                          <input name="submit" type="submit" value="Update Amount" />
                        </p>
                        <p>&nbsp;</p>
